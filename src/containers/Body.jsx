    ...
    <div style={style}>
      <Section title="About Me">
        <p>
          ...
          {
            " Outside of work and school, I have taken interest in building products enabled by ML. "
          }
          {
        ...
        <p>
          {
            "In my free time, I enjoy biking around the San Francisco Bay Area and beyond. If you're interested in my workouts, check out my "
          }
          <SmallLink href="https://www.strava.com/athletes/45024992">
            Strava
          </SmallLink>
          .
        </p>
        ...
        <Tabs
          jobs={[
            ...
            },
            {
              company: "Facebook",
              items: [
                "Worked as an intern on the Graph Embeddings team.",
                "Helped build out an ML graph embedding platform for internal use at Facebook.",
                "Trained and benchmarked models on various graph-related tasks including link prediction and entity resolution.",
              ],
            ...
            },
            {
              company: "iMobile3",
              items: [
                "Built machine learning models to predict merchant churn.",
                "Analyzed data about 22 competitor POS applications.",
                "Created tools to automate business tasks which saved hours for team.",
              ],
          ...
          <Row>
            <Col lg={6} md={6}>
              <Paper
                ...
                link="https://znields.medium.com/are-we-living-in-a-simulation-11c4716e29b"
                date="Sep 21, 2021"
              />
            </Col>
            <Col lg={6} md={6}>
          ...
          <Row>
            ...
            <Col lg={6} md={6}>
              <Paper
                ...
                link="https://medium.com/@znields/cat-parasite-has-mind-and-society-altering-effects-a54266f4a0ad"
                date="Oct 4, 2020"
              />
            </Col>
          </Row>
